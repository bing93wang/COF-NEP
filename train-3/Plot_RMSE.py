...
loglog(loss_5[:, 0], loss_5[:, 4],  linestyle="-", linewidth=lw, label="Energy_train")
loglog(loss_5[:, 0], loss_5[:, 5],  linestyle="-", linewidth=lw, label="Force_train")
loglog(loss_5[:, 0], loss_5[:, 6],  linestyle="-", linewidth=lw, label="Virial_train")
loglog(loss_5[:, 0], loss_5[:, 7],  linestyle="-", linewidth=lw, label="Energy_test")
loglog(loss_5[:, 0], loss_5[:, 8],  linestyle="-", linewidth=lw, label="Force_test")
loglog(loss_5[:, 0], loss_5[:, 9],  linestyle="-", linewidth=lw, label="Virial_test")
xlim([5e1, 2e6])
ylim([1e-3, 6e1])
...
ax3 = subplot(2, 2, 3)
set_fig_properties([gca()])
# x3 = [min(force_test[:, 3:6])-0.1 ,max(force_test[:, 3:6])+0.1]
# y3 = [min(force_test[:, 3:6])-0.1 ,max(force_test[:, 3:6])+0.1]
...
ax4 = subplot(2, 2, 4)
set_fig_properties([gca()])
plot(virial_test_5[:, 0], virial_test_5[:, 6], '.', color="C3", markersize = 10)
plot(virial_test_5[:, 1], virial_test_5[:, 7], '.', color="C3", markersize = 10)
plot(virial_test_5[:, 2], virial_test_5[:, 8], '.', color="C3", markersize = 10)
